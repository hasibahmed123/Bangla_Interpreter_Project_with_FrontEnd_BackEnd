...
Token Lexer::readBanglaWord() {
    ...
    if (it != banglaKeywords.end()) {
        ...
        else if (word == "ছয়") return Token(TokenType::NUM, 6);
        else if (word == "সাত") return Token(TokenType::NUM, 7);
        else if (word == "আট") return Token(TokenType::NUM, 8);
        else if (word == "নয়") return Token(TokenType::NUM, 9);
        else if (word == "দশ") return Token(TokenType::NUM, 10);
